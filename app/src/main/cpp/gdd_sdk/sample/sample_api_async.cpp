...
int main(int argc, const char **argv)
{
    ...
    gddeploy::InferAPI first_infer_api;
    first_infer_api.Init("", first_model_path, first_license_path, 0);

    gddeploy::InferAPI secondary_infer_api;
    secondary_infer_api.Init("", secondary_model_path, secondary_license_path, 0);
