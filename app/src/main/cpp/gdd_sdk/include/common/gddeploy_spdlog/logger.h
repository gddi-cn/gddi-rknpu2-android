...
#include <gddeploy_spdlog/details/backtracer.h>
...
public:
    ...
    void swap(gddeploy_spdlog::logger &other) SPDLOG_NOEXCEPT;
    ...
    template<class T, typename std::enable_if<
                          std::is_convertible<const T &, gddeploy_spdlog::string_view_t>::value && !fmt::is_compile_string<T>::value, int>::type = 0>
    ...
    template<class T, typename std::enable_if<!std::is_convertible<const T &, gddeploy_spdlog::string_view_t>::value &&
...
protected:
    ...
    gddeploy_spdlog::level_t level_{level::info};
    gddeploy_spdlog::level_t flush_level_{level::off};
