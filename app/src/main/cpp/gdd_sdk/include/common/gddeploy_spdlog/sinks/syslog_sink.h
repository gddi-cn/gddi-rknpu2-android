...
public:
    syslog_sink(std::string ident, int syslog_option, int syslog_facility, bool enable_formatting)
        ...
        , syslog_levels_{{/* gddeploy_spdlog::level::trace      */ LOG_DEBUG,
              /* gddeploy_spdlog::level::debug      */ LOG_DEBUG,
              /* gddeploy_spdlog::level::info       */ LOG_INFO,
              /* gddeploy_spdlog::level::warn       */ LOG_WARNING,
              /* gddeploy_spdlog::level::err        */ LOG_ERR,
              /* gddeploy_spdlog::level::critical   */ LOG_CRIT,
              /* gddeploy_spdlog::level::off        */ LOG_INFO}}
